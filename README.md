...
2. Add a `.mp4` (or `.gif`) cover to the [`./public/assets/video`](./public/assets/video) folder, filename should match "slugified" title (e.g. `Party, Darling?` -> `Party-Darling.mp4`)
