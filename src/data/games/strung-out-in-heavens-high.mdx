...
html:root {
  --bg-rgb: 0, 0, 0;
  --text-rgb: 255, 241, 232;
  --accent-rgb: 41, 173, 255;
}
html body {
...
Press ~start~ Z+X if you think you're ready to help our hero to face down his last and worst enemy.

* 1 player. Non-conventional gameplay. Includes glowing ~8-bit~ 4-bit graphics, glam-chiptune music, sordid details and pictures of Japanese girls in synthesis.
...
Inspired by the Famicase [STRUNG OUT in heaven’s high](http://famicase.com/16/softs/78.html) by [Daruma Studio](http://www.daruma.cat/).
